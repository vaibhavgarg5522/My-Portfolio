  ...
  return (
    <footer className="relative z-50 text-white pt-12 pb-6 px-4 sm:px-8 md:px-16 overflow-hidden bg-gradient-to-br from-[#0d0b1a] via-[#16132a] to-[#1e1b38]">
      ...
      >
        ...
        {/* Right: Social Icons */}
        <div className="flex gap-4 sm:gap-5 justify-center" data-aos="fade-up">
      ...
      {/* Footer Note */}
      <div className="text-center text-xs sm:text-sm text-gray-500 mt-6 px-4 z-10 relative" data-aos="fade-up">
