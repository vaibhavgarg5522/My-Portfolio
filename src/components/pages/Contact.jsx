...
const Contact = () => {
  return (
    ...
    >
      {/* Overlay (adjusted for better background visibility) */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="w-full md:w-[60%]">
            <h2 className="text-4xl font-bold bg-[linear-gradient(to_right,black_10%,#8267E3_90%)] inline-block text-right px-10 py-6 rounded-full shadow-xl mb-10 w-[320px] mt-17">
              Get in Touch
            </h2>
            ...
            <a
              ...
              className="flex items-center gap-4 bg-[linear-gradient(145deg,_#1a112b,_#2d165e)] rounded-xl p-4 shadow-md hover:scale-105 transition-transform duration-300"
            >
            ...
            <a
              ...
              className="flex items-center gap-4 bg-[linear-gradient(145deg,_#1a112b,_#2d165e)] rounded-xl p-4 shadow-md hover:scale-105 transition-transform duration-300 mt-10"
            >
              <div className="bg-[#8267E3] text-white rounded-full p-3">
                <FiPhoneCall size={24} />
              </div>
          ...
          {/* Contact Form */}
          <form className="bg-[#121c28] border border-[#8267E3] rounded-xl p-8 space-y-6 md:w-1/2 shadow-2xl">
