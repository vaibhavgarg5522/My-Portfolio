  ...
  return (
    <div>
      ...
      <div
        ...
        className="relative flex items-center justify-start cursor-pointer select-none py-3 px-6 rounded-full shadow-lg border-2 border-[#00C896] overflow-hidden transition-all duration-300 w-[316px]"
        style={{
